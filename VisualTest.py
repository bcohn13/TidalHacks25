...
def transcribe_and_process_chunks(file_path):
    ...
    for i, chunk in enumerate(chunks):
        ...
        try:
            ...
            response = genai.GenerativeModel("gemini-2.0-flash").generate_content([text, prompt])
            #print(response.text)
